    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="register" class="form-input" >
            <div class="imgcontainer"><img src="img_avatar2.png" alt="img_avatar2" class="avatar"/>
...
String dept=request.getParameter("dept");
   String query1="insert into STUDENTREGISTRATION values('"+name+"','"+uid+"','"+pwd+"','"+dept+"','"+email+"' ) ";
   Class.forName("org.apache.derby.jdbc.ClientDriver");
   Connection conn=DriverManager.getConnection("jdbc:derby://localhost:1527/APP","app","app");
    Statement stmt=conn.createStatement();
